...
def setup_for_test():
    """Check to make sure the new student test works."""
    student = Student('Bob Jones', 1)
    return student


def setup_student_with_assignements():
    """Check to make sure assignment funcs work."""
...
def test_read_assignment_score():
    """Test that you access the correct value."""
    student = setup_student_with_assignements()
...
def test_get_gpa():
    """Test that the GPA caluculator algirithm works."""
    student = setup_student_with_assignements()
